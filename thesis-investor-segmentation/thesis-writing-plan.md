...
> 總時程：2026/09 → 2027/06 | 每週投入 10–15 小時 | 更新狀態請在每個 `[ ]` 完成後改為 `[x]`

> ⚠️ **【2026/09/08 時程重新梳理】**
> **緊急節點：2026/10/02 需繳交論文申請書 ＋ 第一至三章初稿（距今 24 天）**
> - Phase 0（研究邊界確認）與 Phase 1（文獻整理）需在 **09/14 前** 收斂，以騰出撰寫時間
> - 第一章目標 **09/21 完成初稿**（✅ 已達成）；第二章目標 **09/25 完成初稿**（2026-09-20 順延，原訂 09/21）
> - 第三章目標 **09/28 完成初稿**，送老師確認後 **10/02 提交**
> - 章節進度詳見 `thesis-chapter-progress.md`
> - Phase 2 起依修訂時程執行（見下方進度儀表板）

---

## 目錄

- [Phase 0：研究題目與邊界確認（需於 09/14 前完成）](#phase-0研究題目與邊界確認需於-0914-前完成)
- [Phase 1：文獻整理與研究計畫書素材（需於 09/14 前收斂）](#phase-1文獻整理與研究計畫書素材需於-0914-前收斂)
- [【緊急】論文前三章撰寫（09/08–10/02）](#緊急論文前三章撰寫-090810-02)
- [Phase 2：資料取得與倫理準備（2026/10–11）](#phase-2資料取得與倫理準備-202610-11)
- [Phase 3：資料清理、EDA 與特徵工程（2026/11–12）](#phase-3資料清理eda-與特徵工程-202611-12)
- [Phase 4：投資人行為分群模型（2026/12–2027/01）](#phase-4投資人行為分群模型-202612-202701)
- [Phase 5：個人化推薦概念驗證（2027/01–02）](#phase-5個人化推薦概念驗證-202701-02)
- [Phase 6：模型評估與比較分析（2027/02）](#phase-6模型評估與比較分析-202702)
- [Phase 7：論文第四、五章撰寫（2027/02–03）](#phase-7論文第四五章撰寫-202702-03)
- [Phase 8：口試準備與畢業（2027/04–06）](#phase-8口試準備與畢業-202704-06)
- [持續性任務（全程）](#持續性任務全程)

---

## Phase 0：研究題目與邊界確認（需於 09/14 前完成）

> 目標：重新確認研究題目、研究範圍、研究對象、資料可行性、不做事項與初步研究問題，避免在邊界未定前繼續擴寫 Proposal。
> **⚠️ 必須在 09/14 前完成，才有足夠時間撰寫前三章。**
...
- [x] 2026-09-15 已確認｜基金類型範圍：共同基金；可交易型錄約 4,000+ 檔
- [x] 2026-09-15 已確認｜投資人定義：研究期間內有基金交易記錄的用戶
- [x] 2026-09-15 已確認｜明確列出本研究不做事項清單（定稿見 `thesis-chapter-progress.md` 1.4：排除完整 robo-advisor、報酬預測、全新演算法開發、共同基金以外商品、即時線上部署、跨平台比較）
- [x] 2026-09-15 已確認｜研究期間：最近 12–18 個月、有交易資料的用戶
- [x] 2026-09-15 已確認｜推薦模型方向：保留完整推薦模型（不降級為概念驗證），組合為熱門推薦 → 內容導向推薦 → 協同過濾／ALS 矩陣分解 → 分群輔助 CF
- [x] 2026-09-15 已確認｜收斂 2–3 個可用資料回答的研究問題（定稿見 `thesis-chapter-progress.md` 1.2）
- [ ] 待確認｜資料授權：尚未跟公司口頭確認，計畫先產出研究架構，再以「執行行銷專案」方向跟老闆討論

**Phase 0 里程碑 🟡**：題目方向、研究範圍、對象、期間、推薦模型組合、研究問題、研究目的、不做事項清單已於 2026-09-15 確認；僅資料授權仍待補，補齊後才可進入 Proposal 定稿。

---

## Phase 1：文獻整理與研究計畫書素材（需於 09/14 前收斂）

> 目標：以 `literature/literature-matrix.md` 整合版文獻矩陣為主，進行核心文獻精讀、來源查證、引用格式整理與研究缺口初稿；暫不擴寫正式 Proposal。
> **⚠️ 已完成精讀：A12、B2、B7、E5、G1。09/14 前重點確認 A6、A7 閱讀完成，剩餘文獻邊寫邊補。**
...
- [ ] 待補文獻：冷啟動問題、Top-K 推薦評估指標、Elbow Method / Silhouette Score、K-prototypes 原始文獻、台灣金融科技 / 數位券商官方報告、個資與研究倫理文獻、Kruskal-Wallis 檢定於分群／客群成效比較之應用文獻（2026-09-20 定案 RQ3 統計方法，需補引用佐證）

### 1-A′ 北商圖書館 2020 年後文獻補強查詢（2026-09-15 新增）

> 詳細檢索式、候選文獻與執行順序見 `literature/ntub-library-search-plan-2020plus.md`。

- [ ] 登入北商電子資源，優先下載已知全文缺口：B1、B6、B9
- [ ] ScienceDirect／SpringerLink／WOS：執行檢索式 1–4，補齊基金／金融商品推薦與評估指標文獻
- [ ] 華藝線上圖書館：執行檢索式 7–9，補台灣券商／財富管理／基金客戶分群文獻
- [ ] 臺灣博碩士論文知識加值系統：執行檢索式 10–12
- [ ] 從候選清單（B-cand、A-cand、E-cand）收斂 6–8 篇精讀，依規則升級為正式編號並寫入 `literature-matrix.md`
...
- [ ] 確認**研究假設**（Research Hypotheses）：
  - H1：整合網站使用者行為特徵（可能結合 GA4、BigQuery、內部資料庫等來源）的分群模型可識別出具商業意義的投資人群體
...
## 【緊急】論文前三章撰寫（09/08–10/02）

> **截止：2026/10/02 繳交論文申請書 ＋ 第一至三章初稿**
> 詳細章節待辦清單請見 `thesis-chapter-progress.md`

| 任務 | 目標日期 |
|------|----------|
| 完成 Phase 0 研究邊界確認 | 09/14 |
| 完成核心文獻整理（A6、A7 補讀） | 09/14 |
| 第一章（緒論）初稿 | 09/21 |
| 第二章（文獻探討）初稿 | 09/25（順延，原訂09/21） |
| 送老師確認第一、二章 | 09/22–09/25 |
| 第三章（研究方法）初稿 | 09/28 |
| 依老師意見修改三章 | 09/29–10/01 |
| 填寫論文申請書、完整提交 | 10/02 |
...
**前三章里程碑 🔴**：10/02 前提交論文申請書 ＋ 前三章初稿

---

## Phase 2：資料取得與倫理準備（2026/10–11）
...
## Phase 5：個人化推薦模型建置（2026/11–12）

> 目標：依 2026-09-15 確認的模型組合，建立熱門推薦 → 內容導向推薦 → 協同過濾／ALS 矩陣分解 → 分群輔助 CF 四種模型，計算 Precision@K / Recall@K / MAP。基金型錄約 4,000+ 檔、活躍交易用戶不少，型錄規模足以支撐 CF／矩陣分解類方法，不再僅止於概念驗證。

### 5-A 資料準備（`notebooks/05-recommendation.ipynb`）

- [ ] 將交易資料轉換為「用戶—基金互動矩陣」（User-Item Matrix）
  - 以購買次數或購買金額作為評分（Implicit Feedback）
- [ ] 準備基金屬性表（風險等級、資產類別、地區、幣別、費用率）供內容導向推薦使用
...
### 5-C 內容導向推薦（Content-based Filtering）

- [ ] 以基金屬性（風險等級、資產類別、地區、幣別）計算基金相似度
- [ ] 對每位用戶依過去持有／交易基金推薦相似基金（K=5, K=10）
- [ ] 計算 Precision@5、Recall@5、Precision@10、Recall@10
- [ ] 記錄結果至評估表格，重點觀察對低交易次數用戶的冷啟動效果

### 5-D 協同過濾／ALS 隱性回饋矩陣分解

- [ ] 使用 `implicit` 套件的 `AlternatingLeastSquares`（ALS），以購買次數/金額作為隱性回饋權重
- [ ] 調整超參數（factors、regularization、iterations）
- [ ] 計算 Precision@5、Recall@5、Precision@10、Recall@10
- [ ] （可選）另跑 `scikit-surprise` 的 Item-Based CF 作次要比較對象
- [ ] 記錄結果至評估表格

### 5-E 分群輔助 CF（核心貢獻）

- [x] 2026-09-20 已定案｜整合方式：**方案 A（分群縮小候選集）**——依群體篩選候選基金池後，再用 ALS 分數排序。方案 B（cluster 標籤作為 ALS 輔助特徵/加權依據）列為第五章「未來研究方向」，本研究不實作。
- [ ] 實驗設計需交代 trade-off：候選池縮小後 Precision 預期提升，但 Recall 可能因漏接跨群相關基金而下降，需在第四章結果分析中明確呈現此消長
- [ ] 計算整合後的 Precision@5、Recall@5、Precision@10、Recall@10、MAP
- [ ] 記錄結果至評估表格，並與純 ALS 結果對照（此組比較是論文最重要的數字）

**Phase 5 里程碑 ✅**：熱門推薦、內容導向推薦、ALS 協同過濾、分群輔助 CF 四模型完成比較，評估指標計算完畢
...
- [ ] **5.5 未來研究方向**（1 頁）：分群標籤作為 CF 模型輸入特徵（cluster-as-feature，非本研究採用之候選集篩選方式）、深度學習（GraphDCF）、即時推薦、跨平台擴展
...
| Phase | 說明 | 目標時程（修訂版） | 完成比例 |
|-------|------|-------------------|---------|
| Phase 0 | 研究邊界確認 | 2026/09/14 前 | 🟡 進行中 |
| Phase 1 | 文獻整理 | 2026/09/14 收斂 | 🟡 進行中（核心已讀） |
| 【緊急】前三章 | 第一至三章初稿 ＋ 申請書 | **2026/10/02** | 🔴 進行中 |
| Phase 2 | 資料取得 | 2026/10–11 | ⏳ 待開始 |
| Phase 3 | EDA 與特徵工程 | 2026/11–12 | ⏳ 未開始 |
| Phase 4 | 分群模型 | 2026/12–2027/01 | ⏳ 未開始 |
| Phase 5 | 推薦模型 | 2027/01–02 | ⏳ 未開始 |
| Phase 6 | 模型評估 | 2027/02 | ⏳ 未開始 |
| Phase 7 | 第四、五章撰寫 | 2027/02–03 | ⏳ 未開始 |
| Phase 8 | 口試準備 | 2027/04–06 | ⏳ 未開始 |

---

*最後更新：2026-09-15 | 版本：v2.1（Phase 0 邊界大致拍板；推薦模型組合改為熱門→內容導向→ALS CF→分群輔助 CF；新增北商圖書館文獻補強查詢待辦）*
