...
- [Phase 5：個人化推薦模型（2026/11–12）](#phase-5個人化推薦模型-202611-12)
...
## Phase 5：個人化推薦模型（2026/11–12）

> 目標：建立 Baseline + 3 種推薦模型，計算 Precision@K / Recall@K。
...
**Phase 5 里程碑 ✅**：4 種推薦模型完成 + 評估指標全部計算完畢
...
- [ ] **2.1 投資人行為分析相關研究**（3–4 頁）：引用 C2, D2, D4, G3, G4, F3
- [ ] **2.2 投資人分群方法相關研究**（4–5 頁）：引用 A1, A2, A3, A4, A5, E2, G1, G2
- [ ] **2.3 推薦系統相關研究**（4–5 頁）：引用 B1, B2, B3, B4, B5, E1, E3
- [ ] **2.4 金融科技與數位券商應用研究**（3–4 頁）：引用 C1, C3, D1, D3, F1, F2
