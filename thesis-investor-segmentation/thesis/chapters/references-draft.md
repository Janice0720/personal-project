...
> **使用狀態**：本檔案為第二章（2.1–2.4 節）目前已引用文獻之 APA 格式清單草稿，2026-09-26 建立。第一、三章尚未系統性建立引用清單，待該章節定稿時比照本檔案格式擴充。書目資訊來源為 `literature/literature-matrix.md` 與各篇 `literature/reading-summaries/*.md`，若與本檔案有出入，以逐頁核對過原文的條目（已於書目後標註核對狀態）為準。
>
...
> 以下文獻**不應**直接以一手引用格式放入最終參考文獻清單，除非正式定稿前已取得原文並核對。若持續以次級引用方式處理，應在正文以「as cited in」或等同的中文表述（如「轉引自」）標示，或依系所規範決定是否可接受次級引用。
...
*建立日期：2026-09-26*
*涵蓋範圍：第二章 2.1–2.4 節已引用文獻；第一、三章尚未建立，2.5 節研究缺口分析定稿後亦須併入*
