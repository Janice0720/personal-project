...
PERSONAS = [
    ...
    },
    {
        ...
        'year':     '112',
        'persona':  '保守固定型',
        'note':     '薪資 ~54%｜利息 ~38%｜股利 ~8%',
        'records': [
            ('薪資', '50',  'A423456004', 500_000,  15_000, '政府機關'),
            ('利息', '5A',  'A423456004', 200_000,  20_000, '合庫銀行定存'),
            ('利息', '5AM', 'A423456004', 150_000,  15_000, '郵局儲蓄存款'),
            ('營利', '54C', 'A423456004',  80_000,       0, '高股息ETF'),
        ],
    },
    {
